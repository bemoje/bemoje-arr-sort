...
describe('Sort Subrange of an Ascending Array with 3 Random Exchanges', function () {
	lengths.forEach(function (length) {
		it('Should sort a size ' + length + ' array', function () {
			for (var i = 0; i < repetitions; i++) {
				var lo = parseInt(length / 4)
...
describe('Sort Subrange of an Ascending Array with 10 Random Elements at Last', function () {
	lengths.forEach(function (length) {
		it('Should sort a size ' + length + ' array', function () {
			for (var i = 0; i < repetitions; i++) {
				var lo = parseInt(length / 4)
...
describe('Lexicographically Sort an Ascending Array with 3 Random Exchanges', function () {
	lengths.forEach(function (length) {
		it('Should sort a size ' + length + ' array', function () {
			for (var i = 0; i < repetitions; i++) {
				var arr1 = ArrayGenerator.ascending3RandomExchangesInt(length)
...
describe('Lexicographically Sort an Ascending Array with 10 Random Elements at Last', function () {
	lengths.forEach(function (length) {
		it('Should sort a size ' + length + ' array', function () {
			for (var i = 0; i < repetitions; i++) {
				var arr1 = ArrayGenerator.ascending10RandomEndInt(length)
...
describe('Lexicographically Sort Subrange of an Array of all Equal Elements', function () {
	lengths.forEach(function (length) {
		it('Should sort a size ' + length + ' array', function () {
			for (var i = 0; i < repetitions; i++) {
				var lo = parseInt(length / 4)
...
describe('Lexicographically Sort Subrange of an Array with Many Duplicates', function () {
	lengths.forEach(function (length) {
		it('Should sort a size ' + length + ' array', function () {
			for (var i = 0; i < repetitions; i++) {
				var lo = parseInt(length / 4)
...
describe('Lexicographically Sort Subrange of an Array with Some Duplicates', function () {
	lengths.forEach(function (length) {
		it('Should sort a size ' + length + ' array', function () {
			for (var i = 0; i < repetitions; i++) {
				var lo = parseInt(length / 4)
