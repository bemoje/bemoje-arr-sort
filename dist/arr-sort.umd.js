(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@bemoje/arr-sort-comparator'), require('@bemoje/assert-args'), require('@bemoje/assert-type'), require('@bemoje/is-function')) :
	typeof define === 'function' && define.amd ? define(['@bemoje/arr-sort-comparator', '@bemoje/assert-args', '@bemoje/assert-type', '@bemoje/is-function'], factory) :
	(global = global || self, global['arr-sort'] = factory(global.arrSortComparator, global.assertArgs, global.assertType, global.isFunction));
}(this, (function (arrSortComparator, assertArgs, assertType, isFunction) { 'use strict';
	 ...
	 */
	function arrSort(arr, compare, lo, hi) {
		assertArgs(arr);
